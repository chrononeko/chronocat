import type { GuildMemberListPayload } from '../../../types'
...
export const guildMemberList = async ({
  ...
  const payload = (await json()) as GuildMemberListPayload
  ...
  return await cctx.chronocat.api['guild.member.list'](payload)
}
