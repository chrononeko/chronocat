...
import type { ApprovePayload, Channel, ChannelGetPayload, ChannelListPayload, ChannelListResponse, ChannelMemberMutePayload, ChannelMutePayload, Event, FriendListResponse, Guild, GuildGetPayload, GuildListResponse, GuildMember, GuildMemberGetPayload, GuildMemberKickPayload, GuildMemberListPayload, GuildMemberListResponse, GuildRemovePayload, Login, Message, MessageCreatePayload, MessageDeletePayload, MessageGetPayload, MessageListPayload, MessageListResponse, Next, User, UserGetPayload, UserPayload } from './satori/types';
...
import type { ChronocatLogCurrentConfig, ChronocatSatoriEventsConfig, ChronocatSatoriServerConfig } from './services/config/configEntity';
