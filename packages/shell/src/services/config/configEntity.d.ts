...
export interface ChronocatSatoriServerConfig extends ChronocatServerConfig, ChronocatHttpServerConfig, ChronocatSatoriEventsConfig {
    type: 'satori';
    /**
     * @title 监听端口
     *
...
export interface ChronocatSatoriWebHookConfig extends ChronocatSatoriEventsConfig {
    type: 'satori_webhook';
    /**
     * @title WebHook URL
     *
